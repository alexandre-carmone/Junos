...
/// stroked with a cyan→violet gradient. Rendered inline so it inherits nothing
/// but its own gradient (independent of the surrounding text color).
...
fn section_card(
    ...
    view! {
        <div class="relative overflow-hidden bg-bg-elev-1 border border-border-base rounded-lg shadow-2 pl-5 pr-4 py-3 flex flex-col gap-2">
    ...
    view! {
        ...
        <div class="max-w-[680px] mx-auto flex flex-col gap-4">
            ...
            <div class="flex items-center gap-3 pb-1">
                <span class="inline-block w-8 h-8 shrink-0" inner_html=JUNOS_LOGO_SVG></span>
