...
translations! {
    ...
    focus_out_btn, focus_no_frame, focus_stars_toggle, focus_settings_not_loaded,
    focus_axis_hfr_px, focus_axis_position, focus_axis_sample, focus_chart_mode_position, focus_chart_mode_index, focus_chart_caption, focus_chart_best, focus_chart_min, focus_chart_waiting, focus_overlay_stars, focus_overlay_median, focus_overlay_kstars_hfr, focus_overlay_scale_note, focus_unit_px, focus_unit_preview_px,
    imaging_camera, imaging_temp, imaging_cooler, imaging_sensor, imaging_progress,
