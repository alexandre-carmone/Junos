...
translations! {
    ...
    mosaic_picking, mosaic_repick, mosaic_pick_sky, mosaic_grid_label, mosaic_overlap_label, mosaic_pa_label, mosaic_cam_no_fov, mosaic_capture_seq,
    ...
    mosaic_step_guide, mosaic_output, mosaic_output_dir, mosaic_output_placeholder, mosaic_send_scheduler, mosaic_err_no_center, mosaic_err_no_frames, mosaic_err_no_fov,
    sched_title, sched_job_singular, sched_job_plural, sched_status_idle, sched_status_running, sched_status_paused, sched_status_unknown, sched_state_idle,
